...
# Github Action role
####################
# NOTE: Commented out for Udacity voclabs accounts with restricted IAM permissions
# If using your own AWS account with full admin access, uncomment these resources
